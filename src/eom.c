...
/**
 * @brief Add the analytic ordered-pair 2PN Hamiltonian contribution to dw/dt.
 *
    ...
    for (int ia = 0; ia < cache->active.num_active; ia++) {
        ...
        for (int ib = 0; ib < cache->active.num_active; ib++) {
            ...
            for (int i = 0; i < D; i++) {
                ...
                const double dH_dpa_i = 2.0 * dH_dpa2 * pai + dH_dpapb * pbi + dH_dNa * ni;
                const double dH_dpb_i = 2.0 * dH_dpb2 * pbi + dH_dpapb * pai + dH_dNb * ni;
...
// Add the reducible b = c ordered-triple 2PN contribution to dw/dt.
static void add_eom_2pn_triple_reducible_pair_analytic(const PairCache *cache, const double *w,
    double *dwdt)
{
    const int D = cache->num_dim;
    const int P0 = cache->array_half;
    ...
    for (int ia = 0; ia < cache->active.num_active; ia++) {
        ...
        for (int ib = 0; ib < cache->active.num_active; ib++) {
            ...
            const double t23 = 17*pb0;
            const double t24 = 17*pb1;
            const double t25 = 17*pb2;
            const double t27 = t18*t18;
            const double t29 = pb0*t16;
            const double t30 = t0*t29;
            const double t31 = pb1*t16;
            const double t32 = t2*t31;
            const double t33 = pb2*t16;
            const double t34 = t33*t4;
            const double t35 = t30 + t32 + t34;
            const double t36 = 2*t22;
            const double t37 = 14*t30 + 14*t32 + 14*t34;
            const double t42 = t4*t33;
            const double t43 = t27*(t0*t29 + t32 + t42);
            const double t44 = pa0*t16;
            const double t45 = 14*t44;
            const double t46 = pa1*t16;
            const double t47 = 14*t46;
            const double t48 = pa2*t16;
            const double t49 = 14*t48;
            const double t50 = t0*t45 + t2*t47 + t4*t49;
            const double t51 = t20*t35;
            const double t52 = t16*t16;
            const double t53 = t0*t52;
            const double t54 = t2*t52;
            const double t55 = t2*t54;
            const double t56 = t4*t52;
            const double t57 = t4*t56;
            const double t58 = t53*t0 + t55 + t57;
            const double t62 = t2*t31 + t4*t33 + t29*t0;
            const double t63 = t27*t35;
            const double t64 = t62*t63;
            const double t65 = 18*t17*(pa0*pa0 + pa1*pa1 + pa2*pa2) - t21*(pa0*pb0 + pa1*pb1 + pa2*pb2) + t22*(14*pb0*pb0 + 14*pb1*pb1 + 14*pb2*pb2) + t27*(pb0*t23 + pb1*t24 + pb2*t25) - t35*t35*t36 + t37*t43 - t50*t51 + t58*t64;
            const double t66 = (1.0/8.0)*ma*mb;
            const double t67 = mb*t66;
            const double t68 = t65*t67;
            const double t69 = t16*t68;
            const double t70 = -t0;
            const double t71 = 1 / sqrt(t6) / t6;
            const double t72 = t16*t71;
            const double t73 = t68*t72;
            const double t74 = 2*xa0 - 2*xb0;
            const double t75 = 5*t53;
            const double t76 = 5*t55 + 5*t57 + t75*t0;
            const double t78 = t22*(pb0*pb0 + pb1*pb1 + pb2*pb2);
            const double t79 = 14*t29;
            const double t80 = t0*t79 + 14*t32 + 14*t42;
            const double t81 = t62*t22;
            const double t82 = 2*t44;
            const double t83 = 2*t46;
            const double t84 = 2*t48;
            const double t85 = t0*t82 + t2*t83 + t4*t84;
            const double t86 = t19*t18;
            const double t87 = t62*t86;
            const double t88 = 2*t29;
            const double t89 = t0*t88 + 2*t32 + 2*t34;
            const double t90 = t62*t62*t22;
            const double t91 = t67*(-t58*t90 + t76*t78 - t80*t81 + t85*t87 + t87*t89)/(t6*t6);
            ...
            const double t168 = t165 + t166 + t167 + t31;
            ...
            const double t176 = t54 + t170 + t171 + t172 + t173 + t174 + t175 + t54;
            const double t178 = t168*t86;
            const double t180 = 5*t54;
            const double t182 = -t4*t7;
            const double t183 = -t4;
            ...
            const double t204 = t201 + t202 + t203 + t33;
            ...
            const double t212 = t56 + t206 + t207 + t208 + t209 + t210 + t211 + t56;
            const double t214 = t204*t86;
            const double t216 = 5*t56;
            const double t218 = t0*t7;
            const double t219 = mb*t218;
            const double t220 = t1*t7;
            const double t221 = pb0*t220;
            const double t222 = t2*t218;
            const double t223 = pb1*t222;
            const double t224 = t218*t4;
            const double t225 = pb2*t224;
            const double t226 = pa0*t220;
            const double t227 = pa1*t222;
            const double t228 = pa2*t224;
            const double t232 = 2*t221 + 2*t223 + 2*t225 - t88;
            const double t233 = t123*t220;
            const double t234 = t125*t222;
            const double t235 = t127*t224;
            const double t236 = -t122 + t233 + t234 + t235;
            const double t237 = t221 + t223 + t225 - t29;
            const double t238 = t2*t7;
            const double t239 = t3*t7;
            const double t240 = pb1*t239;
            const double t241 = pb0*t222;
            const double t242 = t238*t4;
            const double t243 = pb2*t242;
            const double t244 = pa1*t239;
            const double t245 = pa0*t222;
            const double t246 = pa2*t242;
            const double t250 = -t149 + 2*t240 + 2*t241 + 2*t243;
            const double t251 = t125*t239;
            const double t252 = t123*t222;
            const double t253 = t127*t242;
            const double t254 = -t54 + t251 + t252 + t253;
            const double t255 = t240 + t241 + t243 - t31;
            const double t256 = t4*t7;
            const double t257 = t5*t7;
            const double t258 = pb2*t257;
            const double t259 = pb0*t224;
            const double t260 = pb1*t242;
            const double t261 = pa2*t257;
            const double t262 = pa0*t224;
            const double t263 = pa1*t242;
            const double t267 = -t185 + 2*t258 + 2*t259 + 2*t260;
            const double t268 = t127*t257;
            const double t269 = t123*t224;
            const double t270 = t125*t242;
            const double t271 = -t56 + t268 + t269 + t270;
            const double t272 = t258 + t259 + t260 - t33;
            const double t273 = t1*t110;
            const double t274 = t114*t0;
            const double t275 = t117*t0;
            const double t276 = t273 + t274 + t275 - t29;
            const double t277 = t1*t129;
            const double t278 = t133*t0;
            const double t279 = t136*t0;
            const double t280 = t277 + t278 + t279 - t53;
            const double t281 = t276*t86;
            const double t282 = t113*t3;
            const double t283 = t2*t111;
            const double t284 = t2*t117;
            const double t285 = t282 + t283 + t284 - t31;
            const double t286 = t3*t132;
            const double t287 = t2*t130;
            const double t288 = t2*t136;
            const double t289 = t286 + t287 + t288 - t54;
            const double t290 = t285*t86;
            const double t291 = t116*t5;
            const double t292 = t111*t4;
            const double t293 = t114*t4;
            const double t294 = t291 + t292 + t293 - t33;
            const double t295 = t135*t5;
            const double t296 = t4*t130;
            const double t297 = t4*t133;
            const double t298 = t295 + t296 + t297 - t56;
            const double t299 = t294*t86;
            const double t300 = (1.0/4.0)*t62;
            const double t301 = t219*t300;
            const double t302 = t0*t16;
            const double t303 = 14*t51;
            const double t304 = mb*t300;
            const double t305 = t238*t304;
            const double t307 = t256*t304;
            const double t308 = t16*t4;
            ...
            const double t315 = 2*t76*t22;
            const double t316 = 2*t143;
            const double t317 = t125*t86;
            const double t318 = t127*t86;

            dwdt[P0 + a * D + 0] += (-t139*(t103*(t93 + t95 + t97 + t29) - t104*t105 + t104*t121 + t119*t120 + t138*t64 + t43*(t79 + 14*t93 + 14*t95 + 14*t97) - t51*(14*t107 + 14*t108 + 14*t109 + t45) - t98*t99) - t145*(-t119*t140 - t138*t90 + t141*t85 + t141*t89 - t143*(2*t112 + 2*t115 + 2*t118 + t88) + t78*(5*t124 + 5*t126 + 5*t128 + 5*t131 + 5*t134 + 5*t137 + t144 + t75) - t81*(14*t93 + 14*t95 + 14*t97 + t79) + t87*t98 + t87*(2*t107 + 2*t108 + 2*t109 + t82)) - t69*t8 - t70*t73 + t74*t91);
            dwdt[P0 + a * D + 1] += (-t139*(t103*(t151 + t153 + t155 + t31) - t105*t160 + t120*t168 + t121*t160 - t156*t99 + t176*t64 + t43*(14*t151 + 14*t153 + 14*t155 + t161) - t51*(14*t162 + 14*t163 + 14*t164 + t47)) - t145*(-t140*t168 - t143*(2*t165 + 2*t166 + 2*t167 + t149) + t156*t87 - t176*t90 + t178*t85 + t178*t89 + t78*(5*t170 + 5*t171 + 5*t172 + 5*t173 + 5*t174 + 5*t175 + t180 + t180) - t81*(14*t151 + 14*t153 + 14*t155 + t161) + t87*(2*t162 + 2*t163 + 2*t164 + t83)) - t146*t69 - t147*t73 + t148*t91);
            dwdt[P0 + a * D + 2] += (-t139*(t103*(t187 + t189 + t191 + t33) - t105*t196 + t120*t204 + t121*t196 - t192*t99 + t212*t64 + t43*(14*t187 + 14*t189 + 14*t191 + t197) - t51*(14*t198 + 14*t199 + 14*t200 + t49)) - t145*(-t140*t204 - t143*(2*t201 + 2*t202 + 2*t203 + t185) + t192*t87 - t212*t90 + t214*t85 + t214*t89 + t78*(5*t206 + 5*t207 + 5*t208 + 5*t209 + 5*t210 + 5*t211 + t216 + t216) - t81*(14*t187 + 14*t189 + 14*t191 + t197) + t87*(2*t198 + 2*t199 + 2*t200 + t84)) - t182*t69 - t183*t73 + t184*t91);
            dwdt[P0 + b * D + 0] += (-t139*(t103*(t221 + t223 + t225 - t29) - t105*t237 + t121*t237 - t232*t99 + t236*t64 + t43*(-t79 + 14*t221 + 14*t223 + 14*t225) - t51*(14*t226 + 14*t227 + 14*t228 - t45)) - t145*(t232*t87 - t236*t90 + t78*(-t144 + 5*t233 + 5*t234 + 5*t235) - t81*(14*t221 + 14*t223 + 14*t225 - t79) + t87*(2*t226 + 2*t227 + 2*t228 - t82)) - t16*t219*t65*t66 - t74*t91);
            dwdt[P0 + b * D + 1] += (-t139*(t103*(t240 + t241 + t243 - t31) - t105*t255 + t121*t255 - t250*t99 + t254*t64 + t43*(-t161 + 14*t240 + 14*t241 + 14*t243) - t51*(14*t244 + 14*t245 + 14*t246 - t47)) - t145*(t250*t87 - t254*t90 + t78*(-t180 + 5*t251 + 5*t252 + 5*t253) - t81*(-t161 + 14*t240 + 14*t241 + 14*t243) + t87*(2*t244 + 2*t245 + 2*t246 - t83)) - t148*t91 - t238*t69);
            dwdt[P0 + b * D + 2] += (-t139*(t103*(t258 + t259 + t260 - t33) - t105*t272 + t121*t272 - t267*t99 + t271*t64 + t43*(-t197 + 14*t258 + 14*t259 + 14*t260) - t51*(14*t261 + 14*t262 + 14*t263 - t49)) - t145*(t267*t87 - t271*t90 + t78*(-t216 + 5*t268 + 5*t269 + 5*t270) - t81*(-t197 + 14*t258 + 14*t259 + 14*t260) + t87*(2*t261 + 2*t262 + 2*t263 - t84)) - t184*t91 - t256*t69);
            dwdt[P0 + b * D + 0] += (-t139*(t120*t276 + t280*t64) - t145*(-t140*t276 - t143*(-t88 + 2*t273 + 2*t274 + 2*t275) - t280*t90 + t281*t85 + t281*t89 + t78*(5*t277 + 5*t278 + 5*t279 - t75)) - t73*t0);
            dwdt[P0 + b * D + 1] += (-t2*t73 - t139*(t120*t285 + t289*t64) - t145*(-t140*t285 - t143*(-t149 + 2*t282 + 2*t283 + 2*t284) - t289*t90 + t290*t85 + t290*t89 + t78*(-t180 + 5*t286 + 5*t287 + 5*t288)));
            dwdt[P0 + b * D + 2] += (-t4*t73 - t139*(t120*t294 + t298*t64) - t145*(-t140*t294 - t143*(-t185 + 2*t291 + 2*t292 + 2*t293) - t298*t90 + t299*t85 + t299*t89 + t78*(-t216 + 5*t295 + 5*t296 + 5*t297)));
            dwdt[a * D + 0] += (t139*(36*pa0*t17 - pb0*t21 - t302*t303) + t301);
            dwdt[a * D + 1] += (t139*(36*pa1*t17 - pb1*t21 - t303*t125) + t305);
            ...
            dwdt[b * D + 1] += (t139*(-pa1*t21 + pb1*t309 - t105*t125 + t121*t125 + t24*t27 - t125*t310 + t125*t311) + t305);
            dwdt[b * D + 2] += (t139*(-pa2*t21 + pb2*t309 - t105*t308 + t121*t308 + t25*t27 - t308*t310 + t308*t311) + t307);
            dwdt[b * D + 0] += (t139*(pb0*t312 + t103*t302 + t120*t123) + t145*(pb0*t315 - t123*t140 - t123*t316 - t302*t313 + t314*t85 + t314*t89));
            dwdt[b * D + 1] += (t139*(pb1*t312 + t103*t125 + t120*t125) + t145*(pb1*t315 - t125*t140 - t125*t316 - t125*t313 + t317*t85 + t317*t89));
            dwdt[b * D + 2] += (t139*(pb2*t312 + t103*t308 + t120*t127) + t145*(pb2*t315 - t127*t140 - t127*t316 - t308*t313 + t318*t85 + t318*t89));
...
// Add one factorizable 2PN contribution for a pairwise-distinct ordered triple.
static void add_eom_2pn_triple_factorizable_block_one(const PairCache *cache, const double *w,
    int a, int b, int c, double *dwdt)
{
    const int D = cache->num_dim;
    const int P0 = cache->array_half;
    ...
    const double t77 = 1 / (mc*mc);
    const double t78 = t77*(pc0*pc0 + pc1*pc1 + pc2*pc2);
...
// Add one genuine-triangle 2PN contribution for a pairwise-distinct ordered triple.
static void add_eom_2pn_triple_genuine_triangle_one(const PairCache *cache, const double *w,
    int a, int b, int c, double *dwdt)
{
    const int D = cache->num_dim;
    const int P0 = cache->array_half;
    ...
    const double u48 = 6*u11*u11 + u22*u41 + 35*u33*u33 - u33*u42 + u33*u44 - u36*u38 + u39*u40 - u45*u47;
    ...
    const double u89 = 3*u73*u74*u80*u83 + u73*u84*(pa0*u85 + pa1*u86 + pa2*u87 - u82*u88) - u76*(pa0*pb0 + pa1*pb1 + pa2*pb2) - u77*(pa0*pa0 + pa1*pa1 + pa2*pa2 - u80*u80) - u81*(4*pc0*pc0 + 4*pc1*pc1 + 4*pc2*pc2 - 4*u82*u82);
    ...
    const double u154 = u93*(u132*u140 - u132*u153 + u141*u145 + u141*u149 + u146*u148)/(u90*u90*u90);
...
// Add the analytic combined ordered-triple 2PN Hamiltonian contribution to dw/dt.
    ...
    for (int ia = 0; ia < active->num_active; ia++) {
        ...
        for (int ib = ia + 1; ib < active->num_active; ib++) {
            ...
            for (int i = 0; i < D; i++) {
                ...
                dwdt[P0 + a * D + i] += force_i;
                dwdt[P0 + b * D + i] -= force_i;
            }
        }
    }
}
...
static void pn_compute_25pn_chi_dot(const PairCache *cache, int num_bodies, int num_dim,
...
// Compute the 2.5PN position contribution to dw/dt.
static void pn_add_25pn_position_contribution(const PairCache *cache, int num_dim,
    double C[num_dim][num_dim], double *dwdt)
{
    const ActiveList *active = &cache->active;
    ...
    for (int ia = 0; ia < active->num_active; ia++) {
        ...
        for (int k = 0; k < num_dim; k++) {
            ...
            dwdt[a * num_dim + k] += (4.0/45.0) * cache->inv_m[a] * pair_cache_p(cache, a, k) * trC
...
static void pn_add_25pn_momentum_contribution(const PairCache *cache, int num_dim,
    double C[num_dim][num_dim], double *dwdt)
{
    const ActiveList *active = &cache->active;
    const int P0 = cache->array_half;
    ...
    for (int ia = 0; ia < active->num_active; ia++) {
        ...
        for (int ib = ia + 1; ib < active->num_active; ib++) {
            ...
            for (int k = 0; k < num_dim; k++) {
                ...
                dwdt[P0 + a * num_dim + k] -= pref * Gk;
                dwdt[P0 + b * num_dim + k] += pref * Gk;
            }
        }
    }
}
...
// Add the full 2.5PN contribution to dw/dt.
static void add_eom_25pn(const PairCache *cache, int num_bodies, int num_dim,
    double x_dot[num_bodies][num_dim], double p_dot[num_bodies][num_dim], double *dwdt)
{
    if (num_dim != 3)
        errorexit("add_eom_25pn_optimized currently assumes num_dim = 3");

    double C[num_dim][num_dim];

    pn_compute_25pn_chi_dot(cache, num_bodies, num_dim, x_dot, p_dot, C);
    pn_add_25pn_position_contribution(cache, num_dim, C, dwdt);
    pn_add_25pn_momentum_contribution(cache, num_dim, C, dwdt);
}
...
void rhs_pn_nbody(double t, double* w, struct ode_params* ode_params, double* dwdt)
{
    ...
    PairCache *cache = pair_cache_get_workspace(ode_params);
    pair_cache_refresh(cache, w, ode_params, pair_cache_levels_for_rhs(ode_params));
    const ActiveList *active = &cache->active;

    // Time derivatives accumulated from the lower-PN RHS needed for e.g. 2.5PN
    ...
    if (ode_params->pn_terms[0]) {
        for (int ia = 0; ia < active->num_active; ia++) {
            ...
            // Velocities
            for (int i = 0; i < num_dim; i++) {
                result = pair_cache_p(cache, a, i) * inv_ma;
            ...
            for (int ib = ia + 1; ib < active->num_active; ib++) {
                ...
                const double mb = cache->m[b];
                const double inv_r_ab = pair_cache_inv_r(cache, a, b);
                const double inv_r2_ab = inv_r_ab * inv_r_ab;
                const double pref = -ma * mb * inv_r2_ab;

                for (int i = 0; i < num_dim; i++) {
                    result = pref * pair_cache_n(cache, a, b, i);
    ...
    if (ode_params->pn_terms[1]) {
        ...
        for (int ia = 0; ia < active->num_active; ia++) {
            ...
            for (int ib = ia + 1; ib < active->num_active; ib++) {
                ...
                Phi_1pn[a] += cache->m[b] * inv_r_ab;
                Phi_1pn[b] += cache->m[a] * inv_r_ab;
            }
        }
        ...
        for (int ia = 0; ia < active->num_active; ia++) {
            ...
            const double ma = cache->m[a];
            const double inv_ma = cache->inv_m[a];
            const double pa_dot_pa = cache->p2[a];

            for (int i = 0; i < num_dim; i++) {
                const double p_ai = pair_cache_p(cache, a, i);

                // Velocities
                result = -0.5 * pa_dot_pa * inv_ma * inv_ma * inv_ma * p_ai;
                ...
                for (int ib = 0; ib < active->num_active; ib++) {
                    ...
                    const double p_bi = pair_cache_p(cache, b, i);
                    const double n_ab_i = pair_cache_n(cache, a, b, i);
                    const double inv_r_ab = pair_cache_inv_r(cache, a, b);

                    const double pa_dot_pb = pair_cache_p_dot(cache, a, b);
                    const double pb_dot_pb = cache->p2[b];

                    const double nab_dot_pa = pair_cache_n_dot_p(cache, a, b, a);
                    const double nab_dot_pb = pair_cache_n_dot_p(cache, a, b, b);

                    temp = -0.5 * inv_r_ab;
                    result = temp * (6.0 * mb * inv_ma * p_ai - 7.0 * p_bi - nab_dot_pb * n_ab_i);
                    ...
                    result = temp * (
                        3.0 * mb * inv_ma * pa_dot_pa
                      + 3.0 * ma * inv_mb * pb_dot_pb
                      - 7.0 * pa_dot_pb
                    ...
                    result = temp * (nab_dot_pb * p_ai + nab_dot_pa * p_bi);

                    p_dot[a][i] += result;
                    dwdt[array_half + a * num_dim + i] += result;

                    result = ma * mb * inv_r_ab * inv_r_ab * n_ab_i * (Phi_1pn[a] + Phi_1pn[b]);
    ...
    if (ode_params->pn_terms[3]) {
        add_eom_25pn(cache, num_bodies, num_dim, x_dot, p_dot, dwdt);
    }
}
